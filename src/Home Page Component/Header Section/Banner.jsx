import Writer from '../Type Writer/Typewriter'
import AvatarAnimated from '../AvatarAnimated/AvatarAnimated'
export default function Banner(){
    return(
        <>
            <div style={{backgroundColor: 'var(--bg-clr)'}} className="flex flex-wrap bg-slate-900 min-h-[450px] p-10">
                <div class="w-full sm:w-1/2 p-10 text-gray-200 font-medium text-2xl sm:text-4xl leading-snug">
                    <p style={{color: 'var(--para-clr)' }} className='font-bold ' data-aos="fade-right">Hi👋🏻</p>
                    <p style={{color: 'var(--para-clr)' }} className='font-bold' data-aos="fade-right">I am Rina Kushwaha</p>
                    <p data-aos="fade-right"><><Writer/></></p>
                    <div className="w-full mt-12 flex" data-aos="fade-right">
                        <a href='https://www.linkedin.com/in/rinakushwaha/' target='_blank'>
                        ...
                        <a href='https://www.kushwaha123rina@gmail.com' target='_blank'>
                            <button className="bg-gray-200 p-2 font-semibold inline-flex items-center space-x-2 rounded hover:animate-spin">
                            <svg className='w-5 h-5' height="24px" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
                                <path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z"/>
                            </svg>
                            </button>&nbsp;&nbsp;
                        </a>
                        <a href='https://github.com/itiansrina' target='_blank'>
                            <button className="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded hover:animate-spin">
